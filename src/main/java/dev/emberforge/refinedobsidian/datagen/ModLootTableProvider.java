...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.OBSIDIAN_BRICK_SLAB);
        ...
        addDrop(ModBlocks.OBSIDIAN_TILE_SLAB);
